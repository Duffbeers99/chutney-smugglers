            ...
            <div className="space-y-3">
              {myBookedEvents.map((event) => {
                ...
                return (
                  <div
                    key={event._id}
                    className="p-3 rounded-lg bg-card border border-border cursor-pointer hover:bg-card/80 transition-colors"
                    onClick={() => router.push(`/restaurants/${event.restaurantId}`)}
                  >
                      ...
                      <>
                        {isEditing ? (
                          ...
                          <Button
                            onClick={(e) => {
                              e.stopPropagation();
                              handleEditPrice(event._id, event.averagePriceRanking);
                            }}
                            size="sm"
                            variant="outline"
