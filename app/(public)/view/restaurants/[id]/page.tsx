...
export default function PublicRestaurantDetailPage({
  params
}: {
  ...
  const restaurant = useQuery(
    api.publicRestaurants.getPublic,
  ...
  return (
    <Card className="card-parchment">
      <CardContent className="p-4">
        ...
        {/* Notes */}
        {rating.notes && (
          <p className="text-sm text-muted-foreground italic p-2 bg-muted/30 rounded">
            "{rating.notes}"
          </p>
        )}
      </CardContent>
